...
NCountry = {
	...
	LOCAL_MANPOWER_ACCESSIBLE_NON_CORE_FACTOR = -110.02,  -- accessible recruitable factor base
	MAX_NON_CORE_MANPOWER_FACTOR = -111.0,				-- max clamp for recruitable local non core manpower factor for states
