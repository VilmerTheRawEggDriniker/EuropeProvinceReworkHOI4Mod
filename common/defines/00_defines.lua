...
NCountry = {
	...
	LOCAL_MANPOWER_ACCESSIBLE_NON_CORE_FACTOR = -1000.02,  -- accessible recruitable factor base
	MAX_NON_CORE_MANPOWER_FACTOR = -10000.000,				-- max clamp for recruitable local non core manpower factor for states
